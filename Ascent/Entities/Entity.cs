...
namespace Ascent.Entities
{
	public abstract class Entity
	{
        ...
        ///If degrees > 0 the entity is set to turn left. 
        ///If degrees < 0 the entity is set to turn right. 
        ...
        ///Note that both positive and negative values
        ///can be given as input, where positive values
        ///means that the entity is set to move ahead, 
        ///and negative values means that the entity is set to move back. 
        ///If 0 is given as input, the entity will stop its movement, but
        ///will have to decelerate till it stands still, and will thus not
        ///be able to stop its movement immediately, but eventually.
        ///Really controls acceleration
        void setAhead(double dist)
        {
          //TODO
        }

        /// <summary>
        /// Returns the direction that the enity's body is facing, in degrees.
        /// The value returned will be in the range [0, 360).
        /// Note that the heading is like a compass, where 0 means North,
        /// 90 means East, 180 means South, and 270 means West.
        /// </summary>
